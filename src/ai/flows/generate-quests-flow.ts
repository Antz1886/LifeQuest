...
IMPORTANT: Use the 'getCurrentWeather' tool to get the weather for the user's location. The location is '{{{location}}}'. Suggest weather-appropriate activities based on the result. For example, if it's sunny, suggest an outdoor 'Strength' or 'Mind' quest. If it's rainy, suggest an indoor one.
